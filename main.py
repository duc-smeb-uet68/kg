...
hf_token = 'token'
local_model_path = '/data2/cmdir/home/ioit107/.cache/huggingface/hub/models--Qwen--Qwen3-14B/snapshots/40c069824f4251a91eefaf281ebe4c544efd3e18'

OUTPUT_EXCEL = "KG_qwen.xlsx"
SAVE_EVERY_N_ROWS = 3
...
def call_model(generator, prompt: str, max_new_tokens: int = 2048) -> str:
    """
    Gọi model Qwen2.5 theo đúng định dạng chat messages.
    Qwen2.5-Instruct sử dụng chat template nên ta truyền messages thay vì raw text.
    """
    messages = [
        {"role": "system",
         "content": "Bạn là một trợ lý AI thông minh. BẮT BUỘC: Toàn bộ câu trả lời phải bằng TIẾNG VIỆT CÓ DẤU đầy đủ. TUYỆT ĐỐI KHÔNG dùng tiếng Anh, tiếng Trung, hay bất kỳ ngôn ngữ nào khác. KHÔNG dùng gạch chân (_), CamelCase, hay viết dính liền các từ. Các từ phải cách nhau bằng dấu cách bình thường."},
...
Dưới đây là ví dụ — hãy tuân theo đúng định dạng này khi tạo câu hỏi năng lực.
